...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("AHER Shop");

        edtnamapel = (EditText) findViewById(R.id.namapelanggan);
        edtnamapel = (EditText) findViewById(R.id.namabarang);
...
//                String namabarang = edtnamabar.getText().toString().trim();
        ...
        btnhapus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //memberi pada action tombol keluar
            }
        });
